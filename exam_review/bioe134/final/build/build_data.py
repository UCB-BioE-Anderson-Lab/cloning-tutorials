...
- `docs/exam_review/bioe134/final/source/topics.yaml`
- `docs/exam_review/bioe134/final/source/questions/<topic_slug>.txt`

It then produces fast-loading, structured JSON assets consumed by the web UI:
- `docs/exam_review/bioe134/final/data/topics_flat.json`
- `docs/exam_review/bioe134/final/data/question_bank.json`
...
How to run (from the repo root):
  ...
  python docs/exam_review/bioe134/final/build/build_data.py

To override paths, you can run:

  python docs/exam_review/bioe134/final/build/build_data.py \
    --topics docs/exam_review/bioe134/final/source/topics.yaml \
    --questions-dir docs/exam_review/bioe134/final/source/questions \
    --out-dir docs/exam_review/bioe134/final/data
...
def main():
    ...
    ap.add_argument("--topics", default="docs/exam_review/bioe134/final/source/topics.yaml")
    ap.add_argument("--questions-dir", default="docs/exam_review/bioe134/final/source/questions")
    ap.add_argument("--out-dir", default="docs/exam_review/bioe134/final/data")
