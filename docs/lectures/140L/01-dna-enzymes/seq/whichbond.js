...
const Q={
  ...
  exo:{ anchor:"scissile",
    ...
    a:"the same bond, phosphate to 3&#8242; oxygen",
    t:"the difference between them is never the bond; it is which end they start from",
  ...
  pnk:{ anchor:"p5end",
    ...
    t:"the only free one; every other 5&#8242; oxygen is already in the backbone",
