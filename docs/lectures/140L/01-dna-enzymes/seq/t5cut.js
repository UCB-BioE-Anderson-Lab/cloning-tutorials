...
window.Deck.sequence("t5cut", function(slide){
  ...
  return { steps:[
    { note:"Look at the ends of this molecule. It is blunt at one end and has a three prime overhang at the other. Will T5 exonuclease touch it? Take a moment before I put the table up.",
