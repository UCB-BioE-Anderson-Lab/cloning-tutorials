...
window.Deck.sequence("vecphos", function(slide){
  ...
  { s:{G:GAP, ins:0, pv:1, cLo:0, cLi:0, cRo:0, cRi:0},
    ...
    note:"Start with a vector cut by a single enzyme, so its two ends are compatible with each other. Look at what the cut left behind. A restriction enzyme breaks the bond between the three prime oxygen and the phosphorus, so the phosphate is left behind on the five prime side. So each of these two ends has a five prime phosphate on one strand and a three prime hydroxyl on the other, and the two phosphates sit diagonally opposite one another. Those two phosphates are this molecule's licence to be sealed shut.",
