    ...
    return [
      blk(
        ...
        steps([
          ...
          `<b>Pellet ${d.culture_mL} mL</b> of saturated culture. Spin 1 min, pour off the supernatant — <b>bleach it</b> before it goes down the drain.`,
          ...
          "Discard the flow-through and <b>spin 90 s to dry</b>. PE is 70% ethanol and carryover ruins everything downstream.",

          `Move the column to your labelled tube. Add <b>${d.elution_uL} µL EB</b> to the <b>centre of the membrane</b> and spin <b>45 s</b>.`
        ]),
        bullets([
